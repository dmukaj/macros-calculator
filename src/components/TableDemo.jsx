    ...
    <main className="flex flex-col items-center">
      <div className="flex flex-col lg:gap-6 gap-14 w-full">
        <div className=" flex flex-col w-full md:space-y-0 md:gap-8 space-y-8 xl:grid xl:grid-cols-2 items-center justify-center">
          <div className="flex flex-col items-center justify-center p-10 rounded-lg shadow-lg bg-gray-100 hover:bg-gray-50 dark:bg-[#1f1f1f] dark:hover:bg-[#3f3f3f">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg p-10 shadow-lg bg-gray-100 hover:bg-gray-50 dark:bg-[#1f1f1f] dark:hover:bg-[#3f3f3f">
