    ...
    <main className="flex flex-col items-center ">
      <div className="flex flex-col lg:gap-6 gap-14">
        <div className=" flex flex-col w-full md:space-y-0 md:gap-8 space-y-8 xl:grid xl:grid-cols-2 items-center justify-center">
          <div className="flex flex-col h-[50dvh] w-[95dvw] lg:w-[40dvw] items-center justify-center p-10 rounded-lg border dark:border-white shadow-lg bg-card/50">
          ...
          <div className="flex flex-col h-[50dvh] w-[95dvw] lg:w-[40dvw] items-center justify-center rounded-lg p-10 border dark:border-white  shadow-lg bg-card/50">
